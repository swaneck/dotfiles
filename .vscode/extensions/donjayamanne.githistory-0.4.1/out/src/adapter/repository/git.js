...
let Git = class Git {
    ...
    getOriginType() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.exec('remote', 'get-url', 'origin')
                    .then(url => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise(resolve => {
                fs.readdir(dir, (err, filesAndFolders) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const folders = yield Promise.all(filteredItems.filter((item) => __awaiter(this, void 0, void 0, function* () { return (yield fs.stat(item)).isDirectory(); })));
