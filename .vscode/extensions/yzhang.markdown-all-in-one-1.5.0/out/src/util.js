...
const slugifier = require(path.join(exports.officialExtPath, 'out', 'slugify')).githubSlugifier;
...
function slugify(heading) {
    try {
        ...
        vscode_1.window.showWarningMessage('Cannot use VSCode built-in slugify function, fall back to GitHub slugify funtion.');
    }
